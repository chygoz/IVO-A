...
export const NotificationProvider: React.FC<NotificationProviderProps> = ({
  ...
  useEffect(() => {
    if (auth.user?.token) {
      notificationClient.initialize(auth.user.token as string);
  ...
  }, [isConnected, auth?.user?.token, fetchNotifications]);
      ...
      switch (notification.type) {
        ...
        case "order":
          if (notification.metadata?.bookingId) {
            router.push(`/dashboard/orders/${notification.metadata.bookingId}`);
          } else {
        ...
        case "system":
          router.push("dashboard/notifications"); // Go to all notifications page
          break;
