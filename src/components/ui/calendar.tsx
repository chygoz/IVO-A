  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          "bg-primary-50 text-slate-900 dark:bg-slate-800 dark:text-slate-50",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-primary-50 aria-selected:text-slate-900 dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50",
