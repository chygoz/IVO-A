...
import ConversionRateSection from "@/components/analytics/conversion-rate";
import TotalResellerStoresSection from "@/components/analytics/total-reseller-stores-section";
import BestResellerStoreSection from "@/components/analytics/best-reseller-store-section";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1">
              <Suspense fallback={<LoadingAnalytics section="conversion" />}>
            ...
            <div className="md:col-span-2">
              <Suspense
                fallback={<LoadingAnalytics section="resellerStores" />}
              >
                <TotalResellerStoresSection />
              </Suspense>
            </div>
          </div>

          <Suspense fallback={<LoadingAnalytics section="bestResellers" />}>
            <BestResellerStoreSection />
          </Suspense>
        </div>
      </div>
