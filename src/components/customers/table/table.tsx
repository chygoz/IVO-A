...
import { Customer } from "@/actions/business";
  ...
  return (
    <Card className="p-5">
      <div className="flex items-center mb-6">
        <h3 className="font-bold text-text text-[28px] ">All Customers</h3>
                ...
                >
                  <TableCell className="">
                    <div className="flex items-center gap-2">
                      <Avatar>
                        <AvatarImage src={customer.user.avatar} alt="" />
                        <AvatarFallback>
                          {getInitials(
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[#898F9B]">{customer.user.email}</p>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="">
                    <p>{dayjs(customer.createdAt).format("DD/MM/YYYY")}</p>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
